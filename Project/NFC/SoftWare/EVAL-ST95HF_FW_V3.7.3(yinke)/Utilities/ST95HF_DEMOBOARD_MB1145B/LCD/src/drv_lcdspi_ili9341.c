...
static uint16_t paramRotate = 0xE8E8;
...
void LCD_DrawRect(uint16_t Xpos, uint16_t Ypos, uint16_t Width, uint16_t Height)
{
  ...
  LCD_DrawLine(Ypos, Xpos, Height, LCD_DIR_HORIZONTAL);
  LCD_DrawLine(Ypos, (Xpos+ Width), Height, LCD_DIR_HORIZONTAL);
  
  /* draw vertical lines */
  LCD_DrawLine(Ypos, Xpos, Width, LCD_DIR_VERTICAL);
  LCD_DrawLine((Ypos + Height), Xpos, Width, LCD_DIR_VERTICAL);
}
...
void LCD_PowerOn(void)
{
  ...
  delay(120);
	...
	LCD_WriteData(paramRotate); 		 // Memory Access Control //48
	//LCD_WriteData(0x00);
		delay(120);
...
* Description    : Clears the active window below the header frame(200*320).
* Input          : None
* Output         : None
* Return         : None
*******************************************************************************/
...
void LCD_WriteBMP_FAT_size(uint16_t Xpos, uint16_t Ypos, const char* BmpName, uint16_t width, uint8_t height)
{
