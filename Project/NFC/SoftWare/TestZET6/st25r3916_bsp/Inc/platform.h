...
#include "../../st25r3916_bsp/Inc/timer.h"
#include "main.h"
#include "../../st25r3916_bsp/Inc/logger.h"
...
#define ST25R_SS_PIN             SPI1_NSS_Pin    /*!< GPIO pin used for ST25R SPI SS                */
#define ST25R_SS_PORT            SPI1_NSS_GPIO_Port   /*!< GPIO port used for ST25R SPI SS port          */

#ifndef RFAL_USE_I2C
#define ST25R_INT_PIN            MCU_IRQ_Pin    /*!< GPIO pin used for ST25R IRQ                   */
#define ST25R_INT_PORT           MCU_IRQ_GPIO_Port   /*!< GPIO port used for ST25R IRQ port             */
#else
...
#endif /* RFAL_USE_I2C */
#define IRQ_ST25R_EXTI_IRQn      MCU_IRQ_EXTI_IRQn

#define LED_FIELD_Pin
#define LED_FIELD_GPIO_Port
...
#define PLATFORM_USER_BUTTON_PIN     KEY0_Pin          /*!< GPIO pin user button       */
#define PLATFORM_USER_BUTTON_PORT    KEY0_GPIO_Port    /*!< GPIO port user button      */
/**
  * @}
  */
...
#define platformSpiTxRx( txBuf, rxBuf, len )          BSP_SPI_SendRecv(txBuf, rxBuf, len)        /*!< SPI transceive                              */
