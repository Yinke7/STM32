...
void TagEmul(void)
{
  ...
  LCD_Clear(Black);
	...
	if (nfc_tagtype == TT2)       LCD_DisplayStringLine(Line0, (u8*)" TT2 Emulator Mode  ");
	else if (nfc_tagtype == TT4A) LCD_DisplayStringLine(Line0, (u8*)" TT4A Emulator Mode ");
  ...
  LCD_SetTextColor(White);
	...
	LCD_DisplayStringLine(Line4, (u8*)"     ST95HF is      ");
	LCD_DisplayStringLine(Line5, (u8*)"    Waiting for     ");
	LCD_DisplayStringLine(Line6, (u8*)"    Card Reader     ");
